...
if d == 2: 
    ...
    plt.show() 
    # fig.savefig('KS_SDE_2D_trajectory_comparison_chi_4.png', dpi = 300, bbox_inches = 'tight')
...
# Save the data 
# with open('KS_SDE_' + str(d)+ 'D_Particle_learned_trajectory_unif_50_reg_' + str(epsilon) + '_t_' + str(Stopping_time) + '_Chi_' + str(omega) + '_'  + str(number_of_initials) + '.npy', 'wb') as f:
